...
Report any bugs or send us requests [here](https://github.com/FZJ-JSC/JuPin/issues).
Please try to avoid duplications and describe your feedback as best as possible.
Alternatively, you can contact the JSC JuPin developers via the following email address:
[sc@fz-juelich.de](mailto:sc@fz-juelich.de)

## Contribute to Code

You are welcome to contribute to JuPin's code! To do so, please fork the repository on [GitHub](https://github.com/FZJ-JSC/JuPin) and create a pull request (PR). Contributions should follow the following rules:
...
3.  You should **agree to the [Contributors License Agreement](#jupin-contributor-license-agreement)**
...
- Further guidelines will follow in upcoming versions

### JuPin Contributor License Agreement

Thank you for your interest in contributing to JuPin ("We" or "Us").
